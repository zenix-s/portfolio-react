...
const About = () => {
  return (
    <section className=" flex h-screen w-full flex-col justify-between xl:flex-row">
      <div className=" flex h-2/5 xl:h-full w-full items-center justify-center xl:w-1/2">
        <img src={mainimg} alt="icon" className="h-full w-full object-cover object-bottom grayscale main-image-animation" />
      </div>
      <div className="flex h-3/5 xl:h-full w-full flex-col items-center justify-around p-4 xl:w-1/2 xl:items-start xl:justify-center main-section-animation">
